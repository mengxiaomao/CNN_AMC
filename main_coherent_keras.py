...
best_weights_filepath_step1 = data_file+'/weight_data/base_weight_N1000.hdf5'
best_weights_filepath_step2 = data_file+'/weight_data/best_weight_N1000_ultimate.hdf5'
base_test_filepath = data_file+'/test_data/test_N1000_'
...
coff=1  # N/1000 
for snr in SNR:
    train_data=sc.loadmat(base_test_filepath+str(snr)+'dB_co.mat')['train_data']
    signal_data=train_data[:,:signal_size*2]
    snr_data=train_data[:,signal_size*2]
    label_data=train_data[:,signal_size*2+1:]
    signal_data=signal_data.reshape(signal_data.shape[0], signal_size, 2)
